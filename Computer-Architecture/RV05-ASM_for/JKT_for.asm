;------------------------------------
; RV05 - ASM_for (Assembly)
;------------------------------------
; Subject: Computer Architecture
; Student: Juan Kevin Trujillo
;------------------------------------
; WHAT TO DO IN THE TASK: Write an assembly program, that outputs numbers from 1 to N. 
; 						  To read input value N use the function scanf from the language C


;-----------------------------------
; FOR COMPILING (Ubuntu)
; 		nasm -f elf64 JKT_for.asm && gcc -no-pie JKT_for.o -m64 -o JKT_for && ./JKT_for
;-----------------------------------
